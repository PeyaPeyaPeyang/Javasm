...
dependencies {
    ...
    implementation("tokyo.peya:langjal:1.4.0")
...
intellijPlatform {
    pluginConfiguration {
        ...
        description.set(providers.fileContents(layout.projectDirectory.file("../README.md")).asText.map {
            val prefix =
                "An IntelliJ IDEA plugin for JAL, a modern JVM assembly language that makes writing and exploring Java bytecode easy and smart, with rich IDE support."
