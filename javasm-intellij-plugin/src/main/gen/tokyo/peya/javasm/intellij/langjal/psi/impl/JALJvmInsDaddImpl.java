...
public class JALJvmInsDaddImpl extends JALInstructionImpl implements JALJvmInsDadd {

  public JALJvmInsDaddImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDadd(this);
  }
