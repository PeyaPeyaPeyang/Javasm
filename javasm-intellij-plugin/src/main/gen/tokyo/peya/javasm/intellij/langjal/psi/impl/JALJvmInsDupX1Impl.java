...
public class JALJvmInsDupX1Impl extends JALInstructionImpl implements JALJvmInsDupX1 {

  public JALJvmInsDupX1Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDupX1(this);
  }
