...
public class JALJvmInsD2LImpl extends JALInstructionImpl implements JALJvmInsD2L {

  public JALJvmInsD2LImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsD2L(this);
  }
