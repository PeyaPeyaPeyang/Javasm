...
public class JALJvmInsLloadNImpl extends JALInstructionImpl implements JALJvmInsLloadN {

  public JALJvmInsLloadNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLloadN(this);
  }
