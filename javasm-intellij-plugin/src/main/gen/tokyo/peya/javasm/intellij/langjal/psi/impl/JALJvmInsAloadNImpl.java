...
public class JALJvmInsAloadNImpl extends JALInstructionImpl implements JALJvmInsAloadN {

  public JALJvmInsAloadNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAloadN(this);
  }
