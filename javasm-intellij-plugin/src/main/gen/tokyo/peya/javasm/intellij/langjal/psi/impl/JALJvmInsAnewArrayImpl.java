...
public class JALJvmInsAnewArrayImpl extends JALInstructionImpl implements JALJvmInsAnewArray {

  public JALJvmInsAnewArrayImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAnewArray(this);
  }
