...
public class JALJvmInsLsubImpl extends JALInstructionImpl implements JALJvmInsLsub {

  public JALJvmInsLsubImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLsub(this);
  }
