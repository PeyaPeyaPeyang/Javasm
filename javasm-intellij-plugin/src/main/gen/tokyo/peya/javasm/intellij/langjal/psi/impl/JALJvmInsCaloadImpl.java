...
public class JALJvmInsCaloadImpl extends JALInstructionImpl implements JALJvmInsCaload {

  public JALJvmInsCaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsCaload(this);
  }
