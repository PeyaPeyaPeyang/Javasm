...
public class JALJvmInsIfNullImpl extends JALInstructionImpl implements JALJvmInsIfNull {

  public JALJvmInsIfNullImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIfNull(this);
  }
