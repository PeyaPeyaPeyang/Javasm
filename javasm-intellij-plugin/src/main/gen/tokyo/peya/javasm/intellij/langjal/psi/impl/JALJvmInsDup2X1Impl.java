...
public class JALJvmInsDup2X1Impl extends JALInstructionImpl implements JALJvmInsDup2X1 {

  public JALJvmInsDup2X1Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDup2X1(this);
  }
