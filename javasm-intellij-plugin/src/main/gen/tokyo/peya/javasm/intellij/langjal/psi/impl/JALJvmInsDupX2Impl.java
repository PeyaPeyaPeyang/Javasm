...
public class JALJvmInsDupX2Impl extends JALInstructionImpl implements JALJvmInsDupX2 {

  public JALJvmInsDupX2Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDupX2(this);
  }
