...
public class JALJvmInsIsubImpl extends JALInstructionImpl implements JALJvmInsIsub {

  public JALJvmInsIsubImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIsub(this);
  }
