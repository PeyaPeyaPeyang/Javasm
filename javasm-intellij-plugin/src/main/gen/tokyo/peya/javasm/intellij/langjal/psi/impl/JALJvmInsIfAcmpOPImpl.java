...
public class JALJvmInsIfAcmpOPImpl extends JALInstructionImpl implements JALJvmInsIfAcmpOP {

  public JALJvmInsIfAcmpOPImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIfAcmpOP(this);
  }
