...
public class JALJvmInsPop2Impl extends JALInstructionImpl implements JALJvmInsPop2 {

  public JALJvmInsPop2Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsPop2(this);
  }
