...
public class JALJvmInsIstoreImpl extends JALInstructionImpl implements JALJvmInsIstore {

  public JALJvmInsIstoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIstore(this);
  }
