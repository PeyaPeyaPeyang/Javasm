...
public class JALJvmInsDaloadImpl extends JALInstructionImpl implements JALJvmInsDaload {

  public JALJvmInsDaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDaload(this);
  }
