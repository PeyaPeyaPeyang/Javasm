...
public class JALJvmInsLaddImpl extends JALInstructionImpl implements JALJvmInsLadd {

  public JALJvmInsLaddImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLadd(this);
  }
