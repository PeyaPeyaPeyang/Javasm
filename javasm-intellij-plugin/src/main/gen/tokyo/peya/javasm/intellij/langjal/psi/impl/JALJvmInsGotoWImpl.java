...
public class JALJvmInsGotoWImpl extends JALInstructionImpl implements JALJvmInsGotoW {

  public JALJvmInsGotoWImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsGotoW(this);
  }
