...
public class JALJvmInsAloadImpl extends JALInstructionImpl implements JALJvmInsAload {

  public JALJvmInsAloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAload(this);
  }
