...
public class JALAccessLevelImpl extends ASTWrapperPsiElement implements JALAccessLevel {

  public JALAccessLevelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccessLevel(this);
  }
