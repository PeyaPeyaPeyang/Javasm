...
public class JALAccAttrMethodImpl extends ASTWrapperPsiElement implements JALAccAttrMethod {

  public JALAccAttrMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccAttrMethod(this);
  }
