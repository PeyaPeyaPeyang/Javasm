...
public class JALJvmInsAstoreImpl extends JALInstructionImpl implements JALJvmInsAstore {

  public JALJvmInsAstoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAstore(this);
  }
