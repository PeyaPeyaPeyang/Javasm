...
public class JALJvmInsLremImpl extends JALInstructionImpl implements JALJvmInsLrem {

  public JALJvmInsLremImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLrem(this);
  }
