...
public class JALJvmInsD2FImpl extends JALInstructionImpl implements JALJvmInsD2F {

  public JALJvmInsD2FImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsD2F(this);
  }
