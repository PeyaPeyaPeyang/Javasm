...
public class JALJvmInsLloadImpl extends JALInstructionImpl implements JALJvmInsLload {

  public JALJvmInsLloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLload(this);
  }
