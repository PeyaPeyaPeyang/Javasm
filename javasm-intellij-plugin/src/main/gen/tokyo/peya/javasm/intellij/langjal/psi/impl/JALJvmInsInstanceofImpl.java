...
public class JALJvmInsInstanceofImpl extends JALInstructionImpl implements JALJvmInsInstanceof {

  public JALJvmInsInstanceofImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInstanceof(this);
  }
