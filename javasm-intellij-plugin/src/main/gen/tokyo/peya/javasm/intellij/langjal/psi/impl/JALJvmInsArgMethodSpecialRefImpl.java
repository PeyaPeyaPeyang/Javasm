...
public class JALJvmInsArgMethodSpecialRefImpl extends JALInstructionImpl implements JALJvmInsArgMethodSpecialRef {

  public JALJvmInsArgMethodSpecialRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgMethodSpecialRef(this);
  }
