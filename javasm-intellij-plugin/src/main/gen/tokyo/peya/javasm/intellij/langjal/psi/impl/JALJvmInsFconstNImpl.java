...
public class JALJvmInsFconstNImpl extends JALInstructionImpl implements JALJvmInsFconstN {

  public JALJvmInsFconstNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFconstN(this);
  }
