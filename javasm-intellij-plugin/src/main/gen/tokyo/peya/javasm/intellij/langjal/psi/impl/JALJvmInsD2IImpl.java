...
public class JALJvmInsD2IImpl extends JALInstructionImpl implements JALJvmInsD2I {

  public JALJvmInsD2IImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsD2I(this);
  }
