...
public class JALJvmInsSwapImpl extends JALInstructionImpl implements JALJvmInsSwap {

  public JALJvmInsSwapImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsSwap(this);
  }
