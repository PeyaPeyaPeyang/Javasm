...
public class JALJvmInsDremImpl extends JALInstructionImpl implements JALJvmInsDrem {

  public JALJvmInsDremImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDrem(this);
  }
