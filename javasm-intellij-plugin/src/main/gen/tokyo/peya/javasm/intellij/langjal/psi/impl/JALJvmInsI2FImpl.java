...
public class JALJvmInsI2FImpl extends JALInstructionImpl implements JALJvmInsI2F {

  public JALJvmInsI2FImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsI2F(this);
  }
