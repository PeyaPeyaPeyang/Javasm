...
public class JALJvmInsFaddImpl extends JALInstructionImpl implements JALJvmInsFadd {

  public JALJvmInsFaddImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFadd(this);
  }
