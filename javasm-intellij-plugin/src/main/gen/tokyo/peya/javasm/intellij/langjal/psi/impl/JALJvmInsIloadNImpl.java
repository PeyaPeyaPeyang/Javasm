...
public class JALJvmInsIloadNImpl extends JALInstructionImpl implements JALJvmInsIloadN {

  public JALJvmInsIloadNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIloadN(this);
  }
