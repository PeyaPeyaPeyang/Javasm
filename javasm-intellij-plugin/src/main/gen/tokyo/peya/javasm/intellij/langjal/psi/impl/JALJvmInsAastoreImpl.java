...
public class JALJvmInsAastoreImpl extends JALInstructionImpl implements JALJvmInsAastore {

  public JALJvmInsAastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAastore(this);
  }
