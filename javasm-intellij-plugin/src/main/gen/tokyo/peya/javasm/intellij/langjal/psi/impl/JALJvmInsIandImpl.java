...
public class JALJvmInsIandImpl extends JALInstructionImpl implements JALJvmInsIand {

  public JALJvmInsIandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIand(this);
  }
