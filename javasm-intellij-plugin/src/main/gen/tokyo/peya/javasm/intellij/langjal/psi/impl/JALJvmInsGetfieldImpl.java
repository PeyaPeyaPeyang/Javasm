...
public class JALJvmInsGetfieldImpl extends JALInstructionImpl implements JALJvmInsGetfield {

  public JALJvmInsGetfieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsGetfield(this);
  }
