...
public class JALJvmInsDupImpl extends JALInstructionImpl implements JALJvmInsDup {

  public JALJvmInsDupImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDup(this);
  }
