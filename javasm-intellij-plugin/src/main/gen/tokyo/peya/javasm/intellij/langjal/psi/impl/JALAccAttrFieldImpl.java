...
public class JALAccAttrFieldImpl extends ASTWrapperPsiElement implements JALAccAttrField {

  public JALAccAttrFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccAttrField(this);
  }
