...
public class JALJvmInsIfIcmpOPImpl extends JALInstructionImpl implements JALJvmInsIfIcmpOP {

  public JALJvmInsIfIcmpOPImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIfIcmpOP(this);
  }
