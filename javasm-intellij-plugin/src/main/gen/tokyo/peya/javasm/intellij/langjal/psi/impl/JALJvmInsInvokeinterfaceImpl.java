...
public class JALJvmInsInvokeinterfaceImpl extends JALInstructionImpl implements JALJvmInsInvokeinterface {

  public JALJvmInsInvokeinterfaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInvokeinterface(this);
  }
