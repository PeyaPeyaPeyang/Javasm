...
public class JALJvmInsFremImpl extends JALInstructionImpl implements JALJvmInsFrem {

  public JALJvmInsFremImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFrem(this);
  }
