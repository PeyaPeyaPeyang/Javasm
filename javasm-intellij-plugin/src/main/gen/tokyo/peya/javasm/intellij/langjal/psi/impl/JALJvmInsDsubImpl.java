...
public class JALJvmInsDsubImpl extends JALInstructionImpl implements JALJvmInsDsub {

  public JALJvmInsDsubImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDsub(this);
  }
