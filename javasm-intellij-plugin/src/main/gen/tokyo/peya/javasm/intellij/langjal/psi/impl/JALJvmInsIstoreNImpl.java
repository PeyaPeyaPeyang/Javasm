...
public class JALJvmInsIstoreNImpl extends JALInstructionImpl implements JALJvmInsIstoreN {

  public JALJvmInsIstoreNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIstoreN(this);
  }
