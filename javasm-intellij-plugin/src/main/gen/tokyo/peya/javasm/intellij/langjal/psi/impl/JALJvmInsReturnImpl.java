...
public class JALJvmInsReturnImpl extends JALInstructionImpl implements JALJvmInsReturn {

  public JALJvmInsReturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsReturn(this);
  }
