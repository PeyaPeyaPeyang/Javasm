...
public class JALJvmInsArgFieldRefNameImpl extends JALInstructionImpl implements JALJvmInsArgFieldRefName {

  public JALJvmInsArgFieldRefNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgFieldRefName(this);
  }
