...
public class JALJvmInsF2LImpl extends JALInstructionImpl implements JALJvmInsF2L {

  public JALJvmInsF2LImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsF2L(this);
  }
