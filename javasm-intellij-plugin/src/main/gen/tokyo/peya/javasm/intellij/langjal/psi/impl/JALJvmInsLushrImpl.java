...
public class JALJvmInsLushrImpl extends JALInstructionImpl implements JALJvmInsLushr {

  public JALJvmInsLushrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLushr(this);
  }
