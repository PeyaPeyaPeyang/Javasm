...
public class JALJvmInsLaloadImpl extends JALInstructionImpl implements JALJvmInsLaload {

  public JALJvmInsLaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLaload(this);
  }
