...
public class JALJvmInsArgTableSwitchImpl extends JALInstructionImpl implements JALJvmInsArgTableSwitch {

  public JALJvmInsArgTableSwitchImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgTableSwitch(this);
  }
