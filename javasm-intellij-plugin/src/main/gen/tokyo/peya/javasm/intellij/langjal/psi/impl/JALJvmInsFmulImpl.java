...
public class JALJvmInsFmulImpl extends JALInstructionImpl implements JALJvmInsFmul {

  public JALJvmInsFmulImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFmul(this);
  }
