...
public class JALJvmInsInvokestaticImpl extends JALInstructionImpl implements JALJvmInsInvokestatic {

  public JALJvmInsInvokestaticImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInvokestatic(this);
  }
