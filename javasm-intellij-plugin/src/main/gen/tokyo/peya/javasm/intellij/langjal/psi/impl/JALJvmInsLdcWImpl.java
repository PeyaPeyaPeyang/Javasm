...
public class JALJvmInsLdcWImpl extends JALInstructionImpl implements JALJvmInsLdcW {

  public JALJvmInsLdcWImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLdcW(this);
  }
