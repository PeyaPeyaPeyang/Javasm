...
public class JALJvmInsLnegImpl extends JALInstructionImpl implements JALJvmInsLneg {

  public JALJvmInsLnegImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLneg(this);
  }
