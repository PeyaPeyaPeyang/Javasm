...
public class JALJvmInsLdcImpl extends JALInstructionImpl implements JALJvmInsLdc {

  public JALJvmInsLdcImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLdc(this);
  }
