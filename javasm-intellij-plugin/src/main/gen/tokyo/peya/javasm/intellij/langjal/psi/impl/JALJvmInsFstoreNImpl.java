...
public class JALJvmInsFstoreNImpl extends JALInstructionImpl implements JALJvmInsFstoreN {

  public JALJvmInsFstoreNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFstoreN(this);
  }
