...
{
    @Override
    protected @NotNull EvaluatedInstruction evaluate(@NotNull EvaluatingContext evalContxt, JALParser.@NotNull JvmInsFcmpgOPContext ctxt)
    {
    ...
    @Override
    protected JALParser.@NotNull JvmInsFcmpgOPContext map(JALParser.@NotNull InstructionContext instruction)
    {
