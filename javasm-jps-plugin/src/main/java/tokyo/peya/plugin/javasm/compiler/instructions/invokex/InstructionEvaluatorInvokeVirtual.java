...
import tokyo.peya.plugin.javasm.compiler.instructions.field.InstructionEvaluateHelperField;
import tokyo.peya.plugin.javasm.langjal.compiler.JALParser;

public class InstructionEvaluatorInvokeVirtual extends AbstractInstructionEvaluator<JALParser.JvmInsInvokevirtualContext>
{
    @Override
