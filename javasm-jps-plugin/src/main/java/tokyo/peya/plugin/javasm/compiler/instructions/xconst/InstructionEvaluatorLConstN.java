...
{
    @Override
    protected @NotNull EvaluatedInstruction evaluate(@NotNull EvaluatingContext evalContxt, JALParser.@NotNull JvmInsLconstNContext ctxt)
    {
    ...
    @Override
    protected JALParser.@NotNull JvmInsLconstNContext map(JALParser.@NotNull InstructionContext instruction)
    {
