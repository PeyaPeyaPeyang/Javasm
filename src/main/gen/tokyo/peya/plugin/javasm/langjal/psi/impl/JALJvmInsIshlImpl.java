...
public class JALJvmInsIshlImpl extends JALInstructionImpl implements JALJvmInsIshl {

  public JALJvmInsIshlImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIshl(this);
  }
