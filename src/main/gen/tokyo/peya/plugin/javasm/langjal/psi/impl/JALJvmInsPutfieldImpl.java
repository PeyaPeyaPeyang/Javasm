...
public class JALJvmInsPutfieldImpl extends JALInstructionImpl implements JALJvmInsPutfield {

  public JALJvmInsPutfieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsPutfield(this);
  }
