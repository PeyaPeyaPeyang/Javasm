...
public class JALJvmInsFreturnImpl extends JALInstructionImpl implements JALJvmInsFreturn {

  public JALJvmInsFreturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFreturn(this);
  }
