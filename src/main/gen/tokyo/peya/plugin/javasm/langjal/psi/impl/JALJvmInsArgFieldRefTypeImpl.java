...
public class JALJvmInsArgFieldRefTypeImpl extends JALInstructionImpl implements JALJvmInsArgFieldRefType {

  public JALJvmInsArgFieldRefTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgFieldRefType(this);
  }
