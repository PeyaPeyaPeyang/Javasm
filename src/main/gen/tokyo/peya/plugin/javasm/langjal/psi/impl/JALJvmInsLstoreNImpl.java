...
public class JALJvmInsLstoreNImpl extends JALInstructionImpl implements JALJvmInsLstoreN {

  public JALJvmInsLstoreNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLstoreN(this);
  }
