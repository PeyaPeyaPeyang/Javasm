...
public class JALJvmInsIremImpl extends JALInstructionImpl implements JALJvmInsIrem {

  public JALJvmInsIremImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIrem(this);
  }
