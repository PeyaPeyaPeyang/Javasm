...
public class JALJvmInsCheckcastImpl extends JALInstructionImpl implements JALJvmInsCheckcast {

  public JALJvmInsCheckcastImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsCheckcast(this);
  }
