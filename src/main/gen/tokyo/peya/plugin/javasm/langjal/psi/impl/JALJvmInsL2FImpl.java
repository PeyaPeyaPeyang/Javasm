...
public class JALJvmInsL2FImpl extends JALInstructionImpl implements JALJvmInsL2F {

  public JALJvmInsL2FImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsL2F(this);
  }
