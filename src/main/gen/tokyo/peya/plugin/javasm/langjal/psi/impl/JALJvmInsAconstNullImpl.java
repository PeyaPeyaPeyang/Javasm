...
public class JALJvmInsAconstNullImpl extends JALInstructionImpl implements JALJvmInsAconstNull {

  public JALJvmInsAconstNullImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAconstNull(this);
  }
