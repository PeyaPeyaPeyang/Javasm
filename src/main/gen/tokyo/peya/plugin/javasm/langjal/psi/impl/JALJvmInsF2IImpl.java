...
public class JALJvmInsF2IImpl extends JALInstructionImpl implements JALJvmInsF2I {

  public JALJvmInsF2IImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsF2I(this);
  }
