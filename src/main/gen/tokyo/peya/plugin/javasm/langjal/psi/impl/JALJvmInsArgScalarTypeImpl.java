...
public class JALJvmInsArgScalarTypeImpl extends JALInstructionImpl implements JALJvmInsArgScalarType {

  public JALJvmInsArgScalarTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgScalarType(this);
  }
