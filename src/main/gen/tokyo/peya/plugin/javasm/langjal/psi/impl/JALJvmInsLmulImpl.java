...
public class JALJvmInsLmulImpl extends JALInstructionImpl implements JALJvmInsLmul {

  public JALJvmInsLmulImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLmul(this);
  }
