...
public class JALJvmInsI2SImpl extends JALInstructionImpl implements JALJvmInsI2S {

  public JALJvmInsI2SImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsI2S(this);
  }
