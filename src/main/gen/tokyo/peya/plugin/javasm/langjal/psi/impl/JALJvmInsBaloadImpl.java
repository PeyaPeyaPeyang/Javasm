...
public class JALJvmInsBaloadImpl extends JALInstructionImpl implements JALJvmInsBaload {

  public JALJvmInsBaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsBaload(this);
  }
