...
public class JALJvmInsLshrImpl extends JALInstructionImpl implements JALJvmInsLshr {

  public JALJvmInsLshrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLshr(this);
  }
