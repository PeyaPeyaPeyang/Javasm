...
public class JALJvmInsLdc2WImpl extends JALInstructionImpl implements JALJvmInsLdc2W {

  public JALJvmInsLdc2WImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLdc2W(this);
  }
