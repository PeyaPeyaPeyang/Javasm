...
public class JALJvmInsFastoreImpl extends JALInstructionImpl implements JALJvmInsFastore {

  public JALJvmInsFastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFastore(this);
  }
