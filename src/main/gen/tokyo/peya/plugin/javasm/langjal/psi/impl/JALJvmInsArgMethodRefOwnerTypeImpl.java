...
public class JALJvmInsArgMethodRefOwnerTypeImpl extends JALInstructionImpl implements JALJvmInsArgMethodRefOwnerType {

  public JALJvmInsArgMethodRefOwnerTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgMethodRefOwnerType(this);
  }
