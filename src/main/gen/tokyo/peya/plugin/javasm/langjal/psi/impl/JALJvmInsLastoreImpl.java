...
public class JALJvmInsLastoreImpl extends JALInstructionImpl implements JALJvmInsLastore {

  public JALJvmInsLastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLastore(this);
  }
