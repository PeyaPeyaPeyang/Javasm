...
public class JALJvmInsDnegImpl extends JALInstructionImpl implements JALJvmInsDneg {

  public JALJvmInsDnegImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDneg(this);
  }
