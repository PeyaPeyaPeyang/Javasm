...
public class JALJvmInsLcmpImpl extends JALInstructionImpl implements JALJvmInsLcmp {

  public JALJvmInsLcmpImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLcmp(this);
  }
