...
public class JALJvmInsI2DImpl extends JALInstructionImpl implements JALJvmInsI2D {

  public JALJvmInsI2DImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsI2D(this);
  }
