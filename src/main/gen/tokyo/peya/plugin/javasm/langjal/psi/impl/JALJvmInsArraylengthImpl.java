...
public class JALJvmInsArraylengthImpl extends JALInstructionImpl implements JALJvmInsArraylength {

  public JALJvmInsArraylengthImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArraylength(this);
  }
