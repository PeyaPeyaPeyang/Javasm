...
public class JALJvmInsSastoreImpl extends JALInstructionImpl implements JALJvmInsSastore {

  public JALJvmInsSastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsSastore(this);
  }
