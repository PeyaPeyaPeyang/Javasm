...
public abstract class JALJvmInsArgInvokeDynamicRefImpl extends JALInstructionImpl implements JALJvmInsArgInvokeDynamicRef {

  public JALJvmInsArgInvokeDynamicRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgInvokeDynamicRef(this);
  }
