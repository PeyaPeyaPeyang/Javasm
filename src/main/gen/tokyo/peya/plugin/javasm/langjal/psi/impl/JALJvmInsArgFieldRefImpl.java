...
public class JALJvmInsArgFieldRefImpl extends JALInstructionImpl implements JALJvmInsArgFieldRef {

  public JALJvmInsArgFieldRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgFieldRef(this);
  }
