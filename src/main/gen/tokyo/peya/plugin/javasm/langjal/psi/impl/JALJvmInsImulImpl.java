...
public class JALJvmInsImulImpl extends JALInstructionImpl implements JALJvmInsImul {

  public JALJvmInsImulImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsImul(this);
  }
