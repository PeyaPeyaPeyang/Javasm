...
public class JALJvmInsDmulImpl extends JALInstructionImpl implements JALJvmInsDmul {

  public JALJvmInsDmulImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDmul(this);
  }
