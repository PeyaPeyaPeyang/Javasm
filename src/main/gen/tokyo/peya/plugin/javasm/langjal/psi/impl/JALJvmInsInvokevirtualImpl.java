...
public class JALJvmInsInvokevirtualImpl extends JALInstructionImpl implements JALJvmInsInvokevirtual {

  public JALJvmInsInvokevirtualImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInvokevirtual(this);
  }
