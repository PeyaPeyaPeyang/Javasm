...
public class JALJvmInsIorImpl extends JALInstructionImpl implements JALJvmInsIor {

  public JALJvmInsIorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIor(this);
  }
