...
public class JALJvmInsAreturnImpl extends JALInstructionImpl implements JALJvmInsAreturn {

  public JALJvmInsAreturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAreturn(this);
  }
