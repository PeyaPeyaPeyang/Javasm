...
public class JALJvmInsIshrImpl extends JALInstructionImpl implements JALJvmInsIshr {

  public JALJvmInsIshrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIshr(this);
  }
