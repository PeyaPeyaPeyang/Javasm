...
public class JALJvmInsF2DImpl extends JALInstructionImpl implements JALJvmInsF2D {

  public JALJvmInsF2DImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsF2D(this);
  }
