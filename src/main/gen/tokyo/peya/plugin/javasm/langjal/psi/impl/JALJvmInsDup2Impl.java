...
public class JALJvmInsDup2Impl extends JALInstructionImpl implements JALJvmInsDup2 {

  public JALJvmInsDup2Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDup2(this);
  }
