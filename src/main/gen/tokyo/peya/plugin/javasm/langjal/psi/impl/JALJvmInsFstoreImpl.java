...
public class JALJvmInsFstoreImpl extends JALInstructionImpl implements JALJvmInsFstore {

  public JALJvmInsFstoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFstore(this);
  }
