...
public class JALJvmInsCastoreImpl extends JALInstructionImpl implements JALJvmInsCastore {

  public JALJvmInsCastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsCastore(this);
  }
