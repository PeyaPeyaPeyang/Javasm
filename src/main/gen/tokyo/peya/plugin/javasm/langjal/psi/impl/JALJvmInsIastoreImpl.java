...
public class JALJvmInsIastoreImpl extends JALInstructionImpl implements JALJvmInsIastore {

  public JALJvmInsIastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIastore(this);
  }
