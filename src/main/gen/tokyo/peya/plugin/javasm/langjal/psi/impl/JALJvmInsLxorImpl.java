...
public class JALJvmInsLxorImpl extends JALInstructionImpl implements JALJvmInsLxor {

  public JALJvmInsLxorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLxor(this);
  }
