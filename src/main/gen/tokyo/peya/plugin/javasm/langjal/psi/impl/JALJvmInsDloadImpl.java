...
public class JALJvmInsDloadImpl extends JALInstructionImpl implements JALJvmInsDload {

  public JALJvmInsDloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDload(this);
  }
