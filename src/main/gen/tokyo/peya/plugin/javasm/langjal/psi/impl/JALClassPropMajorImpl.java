...
public class JALClassPropMajorImpl extends ASTWrapperPsiElement implements JALClassPropMajor {

  public JALClassPropMajorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitClassPropMajor(this);
  }
