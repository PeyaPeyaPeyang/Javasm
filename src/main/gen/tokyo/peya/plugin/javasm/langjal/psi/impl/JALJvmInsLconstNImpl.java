...
public class JALJvmInsLconstNImpl extends JALInstructionImpl implements JALJvmInsLconstN {

  public JALJvmInsLconstNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLconstN(this);
  }
