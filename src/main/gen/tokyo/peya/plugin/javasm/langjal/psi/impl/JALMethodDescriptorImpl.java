...
public class JALMethodDescriptorImpl extends ASTWrapperPsiElement implements JALMethodDescriptor {

  public JALMethodDescriptorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JALMethodDescriptorArgs getMethodDescriptorArgs() {
    return findChildByClass(JALMethodDescriptorArgs.class);
  }
