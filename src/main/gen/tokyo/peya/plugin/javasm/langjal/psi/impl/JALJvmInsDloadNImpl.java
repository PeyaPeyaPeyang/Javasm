...
public class JALJvmInsDloadNImpl extends JALInstructionImpl implements JALJvmInsDloadN {

  public JALJvmInsDloadNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDloadN(this);
  }
