...
public class JALJvmInsDastoreImpl extends JALInstructionImpl implements JALJvmInsDastore {

  public JALJvmInsDastoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDastore(this);
  }
