...
public class JALJvmInsAaloadImpl extends JALInstructionImpl implements JALJvmInsAaload {

  public JALJvmInsAaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAaload(this);
  }
