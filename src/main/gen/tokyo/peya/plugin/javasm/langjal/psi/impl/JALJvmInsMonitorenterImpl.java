...
public class JALJvmInsMonitorenterImpl extends JALInstructionImpl implements JALJvmInsMonitorenter {

  public JALJvmInsMonitorenterImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsMonitorenter(this);
  }
