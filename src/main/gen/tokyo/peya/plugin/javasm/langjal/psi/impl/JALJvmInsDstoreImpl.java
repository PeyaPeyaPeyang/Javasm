...
public class JALJvmInsDstoreImpl extends JALInstructionImpl implements JALJvmInsDstore {

  public JALJvmInsDstoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDstore(this);
  }
