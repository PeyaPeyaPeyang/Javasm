...
public class JALAccModFieldImpl extends ASTWrapperPsiElement implements JALAccModField {

  public JALAccModFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccModField(this);
  }
  ...
  @Override
  @NotNull
  public List<JALAccAttrField> getAccAttrFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JALAccAttrField.class);
  }
