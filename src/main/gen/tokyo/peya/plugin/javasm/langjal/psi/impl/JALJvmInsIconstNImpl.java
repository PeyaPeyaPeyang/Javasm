...
public class JALJvmInsIconstNImpl extends JALInstructionImpl implements JALJvmInsIconstN {

  public JALJvmInsIconstNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIconstN(this);
  }
