...
public class JALJvmInsInvokespecialImpl extends JALInstructionImpl implements JALJvmInsInvokespecial {

  public JALJvmInsInvokespecialImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInvokespecial(this);
  }
