...
public class JALJvmInsLandImpl extends JALInstructionImpl implements JALJvmInsLand {

  public JALJvmInsLandImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLand(this);
  }
