...
public class JALJvmInsArgUnsigned8BytesImpl extends JALInstructionImpl implements JALJvmInsArgUnsigned8Bytes {

  public JALJvmInsArgUnsigned8BytesImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgUnsigned8Bytes(this);
  }
  ...
  public PsiElement getInsnArgUnsig8Bytes() {
    return findNotNullChildByType(INSN_ARG_UNSIG_8BYTES);
  }
