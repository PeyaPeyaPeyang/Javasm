...
public class JALJvmInsFloadNImpl extends JALInstructionImpl implements JALJvmInsFloadN {

  public JALJvmInsFloadNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFloadN(this);
  }
