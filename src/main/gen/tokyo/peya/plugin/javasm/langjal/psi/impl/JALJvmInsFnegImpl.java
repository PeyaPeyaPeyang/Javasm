...
public class JALJvmInsFnegImpl extends JALInstructionImpl implements JALJvmInsFneg {

  public JALJvmInsFnegImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFneg(this);
  }
