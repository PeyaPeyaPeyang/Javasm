...
public class JALJvmInsDreturnImpl extends JALInstructionImpl implements JALJvmInsDreturn {

  public JALJvmInsDreturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDreturn(this);
  }
