...
public class JALTypeDescriptorPrimitiveImpl extends ASTWrapperPsiElement implements JALTypeDescriptorPrimitive {

  public JALTypeDescriptorPrimitiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitTypeDescriptorPrimitive(this);
  }
