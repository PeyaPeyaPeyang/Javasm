...
public class JALAccModMethodImpl extends ASTWrapperPsiElement implements JALAccModMethod {

  public JALAccModMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccModMethod(this);
  }
  ...
  @Override
  @NotNull
  public List<JALAccAttrMethod> getAccAttrMethodList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JALAccAttrMethod.class);
  }
