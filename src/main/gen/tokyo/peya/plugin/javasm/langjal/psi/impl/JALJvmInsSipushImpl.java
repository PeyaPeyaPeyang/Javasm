...
public class JALJvmInsSipushImpl extends JALInstructionImpl implements JALJvmInsSipush {

  public JALJvmInsSipushImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsSipush(this);
  }
