...
public class JALJvmInsInegImpl extends JALInstructionImpl implements JALJvmInsIneg {

  public JALJvmInsInegImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIneg(this);
  }
