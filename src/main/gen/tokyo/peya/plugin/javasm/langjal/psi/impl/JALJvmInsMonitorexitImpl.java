...
public class JALJvmInsMonitorexitImpl extends JALInstructionImpl implements JALJvmInsMonitorexit {

  public JALJvmInsMonitorexitImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsMonitorexit(this);
  }
