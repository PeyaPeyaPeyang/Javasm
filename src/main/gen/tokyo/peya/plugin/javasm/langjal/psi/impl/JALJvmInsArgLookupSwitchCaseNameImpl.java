...
public class JALJvmInsArgLookupSwitchCaseNameImpl extends JALInstructionImpl implements JALJvmInsArgLookupSwitchCaseName {

  public JALJvmInsArgLookupSwitchCaseNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgLookupSwitchCaseName(this);
  }
