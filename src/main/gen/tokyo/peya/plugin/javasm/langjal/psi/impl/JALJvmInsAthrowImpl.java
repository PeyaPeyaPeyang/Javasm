...
public class JALJvmInsAthrowImpl extends JALInstructionImpl implements JALJvmInsAthrow {

  public JALJvmInsAthrowImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAthrow(this);
  }
