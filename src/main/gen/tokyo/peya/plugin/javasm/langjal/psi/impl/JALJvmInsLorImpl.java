...
public class JALJvmInsLorImpl extends JALInstructionImpl implements JALJvmInsLor {

  public JALJvmInsLorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsLor(this);
  }
