...
public class JALJvmInsFsubImpl extends JALInstructionImpl implements JALJvmInsFsub {

  public JALJvmInsFsubImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFsub(this);
  }
