...
public class JALAccAttrClassImpl extends ASTWrapperPsiElement implements JALAccAttrClass {

  public JALAccAttrClassImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitAccAttrClass(this);
  }
