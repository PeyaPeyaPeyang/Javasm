...
public class JALJvmInsSaloadImpl extends JALInstructionImpl implements JALJvmInsSaload {

  public JALJvmInsSaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsSaload(this);
  }
