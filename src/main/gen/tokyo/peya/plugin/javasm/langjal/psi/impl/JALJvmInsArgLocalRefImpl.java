...
public class JALJvmInsArgLocalRefImpl extends JALInstructionImpl implements JALJvmInsArgLocalRef {

  public JALJvmInsArgLocalRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsArgLocalRef(this);
  }
