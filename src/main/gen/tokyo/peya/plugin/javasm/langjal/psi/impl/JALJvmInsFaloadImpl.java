...
public class JALJvmInsFaloadImpl extends JALInstructionImpl implements JALJvmInsFaload {

  public JALJvmInsFaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFaload(this);
  }
