...
public class JALJvmInsBipushImpl extends JALInstructionImpl implements JALJvmInsBipush {

  public JALJvmInsBipushImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsBipush(this);
  }
