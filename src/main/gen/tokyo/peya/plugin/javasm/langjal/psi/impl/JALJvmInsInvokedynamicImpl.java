...
public class JALJvmInsInvokedynamicImpl extends JALInstructionImpl implements JALJvmInsInvokedynamic {

  public JALJvmInsInvokedynamicImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsInvokedynamic(this);
  }
