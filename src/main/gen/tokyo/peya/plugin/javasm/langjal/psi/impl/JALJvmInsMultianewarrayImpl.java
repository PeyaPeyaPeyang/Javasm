...
public class JALJvmInsMultianewarrayImpl extends JALInstructionImpl implements JALJvmInsMultianewarray {

  public JALJvmInsMultianewarrayImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsMultianewarray(this);
  }
