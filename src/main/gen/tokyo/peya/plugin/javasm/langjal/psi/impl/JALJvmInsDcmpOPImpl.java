...
public class JALJvmInsDcmpOPImpl extends JALInstructionImpl implements JALJvmInsDcmpOP {

  public JALJvmInsDcmpOPImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDcmpOP(this);
  }
