...
public class JALJvmInsDup2X2Impl extends JALInstructionImpl implements JALJvmInsDup2X2 {

  public JALJvmInsDup2X2Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsDup2X2(this);
  }
