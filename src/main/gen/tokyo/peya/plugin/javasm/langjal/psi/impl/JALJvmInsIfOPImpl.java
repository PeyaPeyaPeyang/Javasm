...
public class JALJvmInsIfOPImpl extends JALInstructionImpl implements JALJvmInsIfOP {

  public JALJvmInsIfOPImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIfOP(this);
  }
