...
public class JALJvmInsNewImpl extends JALInstructionImpl implements JALJvmInsNew {

  public JALJvmInsNewImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsNew(this);
  }
