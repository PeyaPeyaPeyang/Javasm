...
public class JALJvmInsAstoreNImpl extends JALInstructionImpl implements JALJvmInsAstoreN {

  public JALJvmInsAstoreNImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsAstoreN(this);
  }
