...
public class JALJvmInsIaloadImpl extends JALInstructionImpl implements JALJvmInsIaload {

  public JALJvmInsIaloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIaload(this);
  }
