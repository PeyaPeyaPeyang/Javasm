...
public class JALJvmInsIloadImpl extends JALInstructionImpl implements JALJvmInsIload {

  public JALJvmInsIloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIload(this);
  }
