...
public class JALJvmInsIxorImpl extends JALInstructionImpl implements JALJvmInsIxor {

  public JALJvmInsIxorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIxor(this);
  }
