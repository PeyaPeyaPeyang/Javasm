...
public class JALJvmInsIincImpl extends JALInstructionImpl implements JALJvmInsIinc {

  public JALJvmInsIincImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIinc(this);
  }
