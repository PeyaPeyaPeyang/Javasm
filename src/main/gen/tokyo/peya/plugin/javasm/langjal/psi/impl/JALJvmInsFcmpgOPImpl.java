...
public class JALJvmInsFcmpgOPImpl extends JALInstructionImpl implements JALJvmInsFcmpgOP {

  public JALJvmInsFcmpgOPImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsFcmpgOP(this);
  }
