...
public class JALJvmInsIaddImpl extends JALInstructionImpl implements JALJvmInsIadd {

  public JALJvmInsIaddImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JALVisitor visitor) {
    visitor.visitJvmInsIadd(this);
  }
