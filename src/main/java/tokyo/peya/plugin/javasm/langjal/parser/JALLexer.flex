...
<YYINITIAL> {
  ...
  "major_version"                   { return KWD_CLASS_PROP_MAJOR; }
  "minor_version"                   { return KWD_CLASS_PROP_MINOR; }
  "super_class"                     { return KWD_CLASS_PROP_SUPER_CLASS; }
  "interfaces"                      { return KWD_CLASS_PROP_INTERFACES; }
